...
output_dir <- "Output_JCI_Schwann_enrichment/CellType_Comparison"
...
comparison_groups <- c("DREXvsDR", "DREXvsHFD", "EXvsHFD", "DRvsHFD")

# Which gene sets to focus on
focus_sets <- c("Overlap_MS", "Overlap_All3")  # Most relevant overlaps

# Enrichment file patterns
enrichment_types <- c("clusterProfiler_GO", "clusterProfiler_KEGG", "richR_GO", "richR_KEGG")
